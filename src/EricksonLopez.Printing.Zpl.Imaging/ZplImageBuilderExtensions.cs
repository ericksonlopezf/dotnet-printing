...
public static class ZplImageBuilderExtensions
{
    ...
    [SuppressMessage("Major Code Smell", "S107:Methods should not have too many parameters", Justification = "Fluent builder extension method provides complete graphic field configuration with sensible defaults.")]
    [SuppressMessage("csharpsquid", "S107", Justification = "Fluent builder extension method provides complete graphic field configuration with sensible defaults.")]
    public static ZplBuilder Image(
        this ZplBuilder builder,
        int x,
        int y,
