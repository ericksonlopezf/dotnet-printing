...
public sealed class ZplBuilder
{
        ...
        ZplOrientation orientation = ZplOrientation.Normal)
    {
        ...
        _sb.Append("^FO").Append(x).Append(',').Append(y)
           .Append("^BC").Append((char)orientation).Append(',').Append(height).Append(',').Append(showText ? 'Y' : 'N').Append(",N,N")
        ...
        ZplOrientation orientation = ZplOrientation.Normal)
    {
        ...
        _sb.Append("^FO").Append(x).Append(',').Append(y)
           .Append("^B3").Append((char)orientation).Append(",N,").Append(height).Append(',').Append(showText ? 'Y' : 'N').Append(",N")
           .Append("^FD").Append(data).AppendLine("^FS");
        return this;
    }
        ...
        ZplOrientation orientation = ZplOrientation.Normal)
    {
        ...
        _sb.Append("^FO").Append(x).Append(',').Append(y)
           .Append("^BE").Append((char)orientation).Append(',').Append(height).Append(',').Append(showText ? 'Y' : 'N').Append(",N")
           .Append("^FD").Append(data).AppendLine("^FS");
        return this;
    }
