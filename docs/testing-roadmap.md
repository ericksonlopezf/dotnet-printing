...
This document serves as the **single source of truth, execution guide, reproducible evidence, and idempotent tracking mechanism** for the testing, cleanup, and mutation testing strategy of `EricksonLopez.Printing`.
...
```
src/
├── EricksonLopez.Printing                       # Package component
├── EricksonLopez.Printing.EscPos                # Package component
├── EricksonLopez.Printing.EscPos.Imaging        # Package component
├── EricksonLopez.Printing.EscPos.Status         # Package component
├── EricksonLopez.Printing.Serial                # Package component
├── EricksonLopez.Printing.SignalR               # Package component
├── EricksonLopez.Printing.Zpl                   # Package component
├── EricksonLopez.Printing.Zpl.Imaging           # Package component
```
...
| **U02** | `EscPos` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U03** | `EscPos.Imaging` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U04** | `EscPos.Status` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U05** | `Serial` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U06** | `SignalR` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U07** | `Zpl` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U08** | `Zpl.Imaging` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
